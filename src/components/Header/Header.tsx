...
import "./Header.css";
import { faBars, faCartShopping, faEuroSign, faHome, faQuestion, faRightFromBracket, faUser, faUtensils, } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="offcanvas-container">
          <Offcanvas show={show} onHide={handleClose} scroll={true} backdrop={true} placement="end" style={{
            ...
            <Offcanvas.Body style={{
              ...
              {isAuthenticated() && (
                <Navbar.Brand onClick={doLogout} style={{ color: "#fde1c1", width: "100%", cursor: "pointer", display: "block", borderTop: "solid", borderBottom: "solid", margin: "0", padding: "5px" }}>
                  <FontAwesomeIcon data-testid="icon-logout" icon={faRightFromBracket} style={{ fontSize: "1.2em", color: "fde1c1", marginRight: "30px", }} />
                  Logout
                </Navbar.Brand>
              )}
            </Offcanvas.Body>
